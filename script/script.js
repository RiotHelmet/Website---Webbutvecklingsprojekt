...
//   window.location = `player.html?x=${encodeURIComponent(key)}`;
// }
...
function openMenu() {
  if (menuisOpen === true) {
    ...
    let menuBackground = document.getElementById("mobileMenuBackground");
    menu.style.animation = "";
    menuBackground.style.animation = "";

    menuContainer.style.display = "flex";
    menu.style.animation = "openMenu 0.2s ease-in-out";
    menuBackground.style.animation = "darken 0.5s ease-in-out";
  }
}
...
function closeMenu() {
  ...
  menu.style.animation = "closeMenu 0.2s ease-in-out";
  menuBackground.style.animation = "brighten 0.2s ease-in-out";
  setTimeout(() => {
